...
<head>
    ...
    <link href='/resources/plugins/fullcalendar/fullcalendar.print.css' rel='stylesheet' media='print' />
    ...
    <script src='/resources/plugins/fullcalendar/lang-all.js'></script>
    <script>
        $(function () {
